...
import DeathsIcon from '../icons/death.png'
import '../../style/Cards.css'
const { Option } = Select

var confirmed, deaths, recoveries;
...
const useFetchCovidData = url => {
    ...
    const [selectCountry, setCountry] = useState("Thailand")
...
{/*             <div style={{
                ...
                <Card
                    title={<span style={{ color: "white", fontWeight: "800", fontSize: "25px" }}>Options</span>}
                    style={{
                        width: "30vw",
                        borderRadius: '15px',
            ...
            >
                <Col span={8}>
                    <div className="confirmedCard">
                        <h5 id="confirmedLabel"><span><img src={InfectIcon} width={80}/></span> Infected</h5>
                ...
                <Col span={8}>
                    <Col span={16}>
                        <div className="recoveredCard">
                            <h5 id="recoveredLabel"><span><img src={RecoveredIcon} width={60}/></span> Recovered</h5>
                            <h1 id="recoveredValueLabel">{recoveries}</h1>
                        </div>
                    </Col>
                    <Col span={16}>
                        <div className="deathsCard" style={{ marginTop: "10px" }}>
                            <h5 id="deathsLabel"><span><img src={DeathsIcon} width={60}/></span> Deaths</h5>
